/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: dd1a32d8d86c58fda8d1ccdc5c005c17)
// Runtime types generated with workerd@1.20260721.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	InfraAgent: DurableObjectNamespace<import("./src/server").InfraAgent>;
	PROVISION_WORKFLOW: Workflow<Parameters<import("./src/server").ProvisionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "InfraAgent";
	}
